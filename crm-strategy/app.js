!(function () {
  ...
  const P = f.forwardRef(
    ...
    q = [
      ...
      {
        title: "Продукт не существует как сущность",
        text: "В CRM нет каталога продуктов, классификации и связи «клиент ↔ продукт». ФС не видит историю всех возможных сделок, не может подобрать следующий оффер и оценить потенциал кросс-продаж. Это блокирует аналитику воронки продаж и автоматические рекомендации.",
      },
      {
        title: "Портфель клиента не читается как рабочий инструмент",
        text: "ФС видит номера счетов и регуляторные отчёты вместо клиентского взгляда на портфель. Нет показателей эффективности — доходности и динамики AUM, инструмента сборки и визуализации предложения, фильтрации по типу, валюте и сроку.",
      },
      {
        title: "CRM не помогает продавать проактивно",
        text: "Нет продуктовых триггеров, минимум событийных уведомлений и автоматических задач по изменению поведения клиента. ФС узнаёт о пополнениях, выводах и погашениях постфактум или из других каналов. Система фиксирует прошлое, но не инициирует следующий шаг.",
      },
      {
        title: "Эффективность ФС ограничена инструментально",
        text: "Нет двусторонней интеграции с Outlook и календарём, нет шаблонов коммуникаций, задачи генерируются из механики CRM, а не из логики клиента. Новым ФС негде взять качественную базу для холодного контакта; старые SIM-карты блокируются антиспамом.",
      },
      {
                        ...
                        children: [
                          i.jsxs("section", {
                            ...
                            children: [
                              ...
                              i.jsx("p", {
                                children:
                                  "Для «ИФК» CRM — способ расти без потери глубины отношений: видеть клиента, его портфель, потенциал и историю взаимодействия целиком, концентрировать внимание ФС на значимых событиях и действовать вовремя.",
                              }),
                            ],
                          }),
                          i.jsxs("section", {
                                                ...
                                                children: [
                                                  ...
                                                  i.jsxs("li", {
                                                    children: [
                                                      ...
                                                      i.jsx("span", {
                                                        children:
                                                          "Рубли за период; источник — ИФК-Финанс / КХД.",
                                                      }),
                                                    ],
                                                  }),
                                                ],
                                  ...
                                  i.jsxs("div", {
                                    children: [
                                      ...
                                      i.jsxs("p", {
                                        children: [
                                          i.jsx("strong", {
                                            children: "Цифровые фронты",
                                          }),
                                          " становятся дополнительным масштабируемым каналом персональных предложений и проведения простых операций.",
                                        ],
                                      }),
                                      i.jsx("p", {
                                        children:
                                          "CRM объединяет каналы в единый процесс: определяет контекст и повод, направляет действие в подходящий канал и фиксирует результат.",
                                      }),
                                    ],
                                  }),
                                ],
                ...
                children: [
                  i.jsxs("div", {
                    children: [
                      ...
                      i.jsx("p", {
                        children:
                          "Текущий AUM показывает ценность клиента сегодня. Потенциал отражает возможность развития отношений и концентрации капитала в «ИФК» в будущем.",
                      }),
                    ],
                  }),
                  i.jsxs("aside", {
                      ...
                      i.jsx("div", {
                        ...
                        children: [
                            ...
                            criteria: [
                              {
                                ...
                                action:
                                  "Диапазон внешних активов, доля капитала в «ИФК», дата и уверенность оценки.",
                                sources: [
                                  "Интервью клиента",
                                  "Выписки и отчёты",
                                  "СПАРК / ЕГРЮЛ",
                          ...
                          },
                          {
                            ...
                            description:
                              "Насколько реально перевести выявленный капитал в «ИФК» и что этому мешает.",
                            criteria: [
                              {
                                title:
  ...
  const ee = [
    ...
    },
    {
      ...
      heartTab: "problems",
      keywords:
        "дубли продукт портфель проактивные продажи Outlook календарь сегментация VIP ЕКЦ сервисный кейс Service Case маршрутизация линии поддержки SLA права аудит Excel проблемы контур фиксации",
    },
    {
      id: "heart-goals",
    ...
    },
    {
      ...
      keywords: "способности wave волна 1 волна 2 волна 3 функциональность",
    },
    {
      id: "role-benefits",
      ...
      keywords:
        "маркетинг контроль качества финансовые советники ФС UHNW ЕКЦ операционные подразделения обращения SLA sales force руководители продаж топ-менеджмент финансы CSI ROMI",
    },
    {
      id: "methodology",
      ...
      section: "methodology",
      keywords:
        "жизненный цикл воронка сегментация модель сопровождения проактивная модель владение клиентом ЕКЦ сервисный кейс Service Case каталог сервисов маршрутизация первая вторая третья линия SLA Time to Resolution мотивация",
    },
    {
    ...
    },
    {
      ...
      section: "tech",
      keywords:
        "Bitrix платформа GAP интеграции Outlook календарь бэк-офис КХД DWH AI ИИ речевая аналитика звонки адаптация AI-инструменты кастомизация архитектура данные мастер-система CRM ID дедупликация клиентские отношения коммерческий процесс сервис SLA покрытие базы рабочее пространство ФС офис поля мобильный доступ ИФК-Финанс брокерский отчёт операционные документы процессные данные финансовые транзакционные данные",
    },
    {
      id: "organization",
    ...
    },
    {
      ...
      section: "roadmap",
      keywords:
        "функциональная карта сейчас as is волна 1 волна 2 волна 3 зрелость слабо средне высоко продажи клиент портфель продукты рабочее место ФС сервис данные аналитика",
    },
    {
      id: "roadmap-wave-1",
      ...
      section: "roadmap",
      keywords:
        "волна 1 воронка первичных продаж профиль клиента продуктовый справочник рабочее место ФС повторные кросс продажи аналитика агентские продажи модель владения клиентом Outlook Dasha Mail 2026",
    },
    {
      id: "roadmap-wave-2",
      ...
      section: "roadmap",
      keywords:
        "волна 2 портфель 360 повторные продажи событийная активация следующий лучший шаг NBA сегментная модель удержание ротация автоматизация рутины мобильные сценарии NPS CSI 2027",
    },
    {
      id: "roadmap-wave-3",
      ...
      section: "roadmap",
      keywords:
        "волна 3 предиктивная аналитика оттока прогноз AUM выручки капитал 360 омниканальные коммуникации NMAG LTV аудит NBA контактная политика 2027",
    },
  ];
        ...
        const t = [
            {
              id: "core",
              title:
                "Сердце CRM-стратегии: миссия, трансформация, проблемы, цели и метрики",
              shortTitle: "Сердце стратегии",
              icon: $,
              color: "bg-slate-900 border-slate-850 text-white",
              darkColor: "#251618",
              description:
                "CRM как бизнес-инициатива: миссия, целевая модель, место в цифровой трансформации, проблемы, цели, NNA и маржинальная доходность AUM.",
            },
            {
              id: "capabilities",
            ...
            },
            {
              ...
              darkColor: "#2563eb",
              description:
                "6 фундаментальных блоков построения жизненного цикла, сегментации, проактивной модели, владения клиентом и мотивации.",
            },
            {
              id: "tech",
        ...
        const b = (e) => {
          ...
          v = [
            {
              ...
              items: [
                ...
                "Каталог продуктов: единый справочник инвестиционных продуктов (ПИФы, ДУ, ноты, брокеридж), классификация, связь «клиент/лид ↔ продукт»",
                ...
                "Работа с агентами (учёт и привлечение агентов, расширение данного канала привлечения)",
              ],
            },
            {
              goalId: 1,
              ...
              items: [
                ...
                "Оперативные уведомления о движении средств (пополнения, выводы) из бэк-офиса",
            ...
            },
            {
              ...
              items: [
                ...
                "Интеграции: бэк-офис (ИФК-Финанс), КХД, внешние источники данных",
            ...
            },
            {
              ...
              roles: [
                ...
                },
                {
                  ...
                  summary:
                    "Увидят клиента целиком, поймут его сервисные проблемы и получат понятный следующий шаг.",
                  items: [
                    "Профиль, портфель, оценка потенциала, история, сервисные обращения и внешние данные — на одном экране.",
                    "Сигналы о пополнениях, выводах, погашениях, снижении активности и проблемах в обслуживании.",
          ...
          y = [
            ...
            },
            {
              ...
              items: [
                "Обучать ФС, руководителей и поддерживающие роли по их рабочим сценариям: жизненный цикл клиента, возможность, следующее действие, сервисный кейс, портфельный обзор и работа с данными",
                                    ...
                                    children: [
                                      i.jsxs("header", {
                                        ...
                                        children: [
                                          ...
                                          i.jsx("p", {
                                            children:
                                              "В офисе и в полях ФС работает в CRM. Необходимые данные и документы доступны через интеграции, а аналитическая и финансовая отчётность формируется в КХД.",
                                          }),
                                        ],
                                      }),
                                      i.jsxs("div", {
                                        ...
                                        children: [
                                          ...
                                          i.jsxs("article", {
                                            ...
                                            children: [
                                              ...
                                              i.jsx("p", {
                                                children:
                                                  "Объединяет клиентский и процессный контекст с финансовыми фактами.",
                                              }),
                                              i.jsxs("ul", {
                                                className:
                                                  "tech-workplace-map__side-list",
                                          ...
                                          i.jsxs("div", {
                                            className:
                                              "tech-workplace-map__flow tech-workplace-map__flow--out",
                                            "aria-hidden": "true",
                                            children: [
                                              i.jsx("span", {
                                                children:
                                                  "Процессные и клиентские данные",
                                              }),
                                              i.jsx("b", { children: "→" }),
                                            ],
                                          }),
                                        ...
                                        children: [
                                          ...
                                          i.jsxs("aside", {
                                            ...
                                            children: [
                                              ...
                                              i.jsx("ul", {
                                                children: [
                                                   "Счета, позиции, операции и движения средств — ИФК-Финанс и учётные системы",
                                              ...
                                              children: [
                                                ...
                                                i.jsxs("ul", {
                                                  ...
                                                  children: [
                                                    i.jsx("li", {
                                                      children:
                                                        "Портфель 360 (балансы, динамика из ИФК).",
                                                    }),
                                                    i.jsx("li", {
                                                      children:
